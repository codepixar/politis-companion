...
function politis_instagram_instance() {
...
// Blog Section
function politis_blog_section( $postnumber ) {
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-6 single-blog">
            ...
            <div class="meta-bottom d-flex justify-content-between">
                ...
                ?>
                <p><?php echo politis_posted_comments();  ?></p>
            </div>
        </div>
...
// 
function politis_section_heading( $title = '', $subtitle = '' ) {
    if( $title || $subtitle ):
    ?>
...
function politis_contact7_form_content( $template, $prop ) {
...
add_filter( 'wpcf7_default_template', 'politis_contact7_form_content', 10, 2 );
