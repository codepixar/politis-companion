...
class politis_author_widget extends WP_Widget {
...
'politis_author_widget', 


// Widget name will appear in UI
esc_html__( '[ Politis ] Author Widget', 'politis-companion' ),

// Widget description
array( 'description' => esc_html__( 'Add author content', 'politis-companion' ), ) 
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Author Name', 'politis-companion' );
}
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'textarea' ) ); ?>"><?php esc_html_e( 'Short Descriptions:' ,'politis-companion'); ?></label> 
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Facebook Url' ) ); ?>"><?php esc_html_e( 'Facebook Url:' ,'politis-companion'); ?></label> 
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Twitter Url' ) ); ?>"><?php esc_html_e( 'Twitter Url:' ,'politis-companion'); ?></label> 
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Dribbble Url' ) ); ?>"><?php esc_html_e( 'Dribbble Url:' ,'politis-companion'); ?></label> 
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'Behance Url' ) ); ?>"><?php esc_html_e( 'Behance Url:' ,'politis-companion'); ?></label> 
...
<p>
	<label for="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>"><?php _e( 'Image', 'politis-companion' ); ?>:</label>
	<div class="politis-media-container">
		<div class="politis-media-inner">
			...
			<span class="politis-no-image" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-noimg" <?php echo wp_kses_post( $no_img_style ); ?>><?php _e( 'No image selected', 'politis-companion' ); ?></span>
		</div>
	
	<input type="text" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'image' ) ); ?>" value="<?php echo esc_attr( $image ); ?>" class="politis-media-url" />

	<input type="button" value="<?php echo _e( 'Remove', 'politis-companion' ); ?>" class="button politis-media-remove" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-remove" <?php echo wp_kses_post( $img_style ); ?> />

	<?php $button_text = ( $image != '' ) ? __( 'Change Image', 'politis-companion' ) : __( 'Select Image', 'politis-companion' ); ?>
	<input type="button" value="<?php echo esc_html( $button_text ); ?>" class="button politis-media-upload" id="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>-button" />
	<br class="clear">
	</div>
</p>
<style>
.politis-media-container {
	width: 98%;
}
...
.politis-media-remove {
	float: left;
	width: 48%;
}

.politis-media-upload {
	float: right;
	width: 48%;
}
</style>
...
jQuery(function($){
    ...
    wpshed_image_upload( '.politis-media-upload' );
    ...
    wpshed_image_remove( '.politis-media-remove' );
...
} // Class politis_author_widget ends here


// Register and load the widget
function politis_author_load_widget() {
	register_widget( 'politis_author_widget' );
}
add_action( 'widgets_init', 'politis_author_load_widget' );