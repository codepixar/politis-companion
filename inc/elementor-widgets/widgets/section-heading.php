 ...
 * @since 1.0
 */
class Politis_sh extends Widget_Base {
	...
	public function get_title() {
		return __( 'Section Heading', 'politis-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'sh_content',
            [
                'label' => __( 'Section Heading', 'politis-companion' ),
            ]
        );
        $this->add_control(
            'sh_sectiontitle',
        ...
        $this->start_controls_section(
            'style_section', [
                'label' => __( 'Style Section', 'politis-companion' ),
