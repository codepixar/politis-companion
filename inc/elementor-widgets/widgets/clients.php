...
class Politis_Clients extends Widget_Base {

	public function get_name() {
		return 'politis-clients';
	}

	public function get_title() {
		return __( 'Clients', 'politis-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'clients_content',
			[
				'label' => __( 'Clients', 'politis-companion' ),
			]
		);
		$this->add_control(
            'clients', [
                'label' => __( 'Client', 'politis-companion' ),
                ...
                'fields' => [
                    ...
                    [
                        'name'  => 'url',
                        'label' => __( 'Client Url', 'politis-companion' ),
                        'type'  => Controls_Manager::TEXT,
                        'default' => '#'
                    ],
                    [
                        'name'  => 'img',
                        'label' => __( 'Client Logo', 'politis-companion' ),
